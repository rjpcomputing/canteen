...
exports.New = ( req, res ) => {
	CustomerModel.Create( req.body )
		.then( ( customer ) => res.send( { success: true, message: "Customer created", customer: customer } ) )
		.catch( ( err ) => {
			console.error( err );
...
exports.Update = ( req, res ) => {
	CustomerModel.Update( req.body )
		.then( ( customer ) => res.send( { success: true, message: "Customer updated", customer: customer } ) )
		.catch( ( err ) => {
			console.error( err );
