...
module.exports = function ( db )
{
	...
	{
		return db.any( "SELECT sale_item.id AS id, sale_item.created_at AS created_at, sale_item.updated_at AS updated_at, purchase_id, product_id, name, description, price, stock FROM sale_item, product WHERE purchase_id = $1 AND sale_item.product_id = product.id", purchaseId );
	};
